...
@section('herramientas')
	...
	<a href="{{ URL::to('reports/downloadExcel/xls') }}"><img src="{{ URL::asset('img/expXLS.gif') }}" class="admin-logo-nav" alt="profile Pic" height="25" width="25" ></a>
	{{--<a href="{{ URL::to('reports/downloadExcel/xls') }}"><button class="btn btn-secondary no-print text-primary" style="height:37px;width:60px" >xls</button></a>
	<a href="{{ URL::to('reports/downloadExcel/xlsx') }}"><button class="btn btn-secondary no-print text-primary" style="height:37px;width:60px">xlsx</button></a>
...
<table  class="table table-striped table-sm"border="1">
	...
	<tbody>
		...
		<tr>
			...
			<td>{{ $user->find($contribution->user_id)->document}}|{{$user->find($contribution->user_id)->name }}  </td>
